		...
		if(category.equals("all")) // categoryX
		{
			if(price_lower==null && price_upper==null) // priceX
			{
				if(keyword==null) // keyword X
					query="select * from 2019_flea_market.products where type='Flea' and status='On Sale'";
				else // keyword O
					query = "select * from 2019_flea_market.products where type='Flea' and status='On Sale' and name like '%"+keyword+"%'";
			}
			else // priceO
			{
				if(keyword==null) // keyword X
					query="select * from 2019_flea_market.products where type='Flea' and status='On Sale' and price>='"+price_lower+"' and price<='"+price_upper+"'";
				else // keyword O
					query = "select * from 2019_flea_market.products where type='Flea' and status='On Sale' and name like '%"+keyword+"%' and price>='"+price_lower+"' and price<='"+price_upper+"'";
			}			
		}
		else // categoryO
		{
			...
			{
				if(keyword==null) // keyword X
					query="select * from 2019_flea_market.products where type='Flea' and status='On Sale' and category='"+category+"'";
				else // keyword O
					query = "select * from 2019_flea_market.products where type='Flea' and status='On Sale' and category='"+category+"' and name like '%"+keyword+"%'";
			}
			else // priceO
			{
				if(keyword==null) // keyword X
					query="select * from 2019_flea_market.products where type='Flea' and status='On Sale' and category='"+category+"' and price>='"+price_lower+"' and price<='"+price_upper+"'";
				else // keyword O
					query = "select * from 2019_flea_market.products where type='Flea' and status='On Sale' and category='"+category+"' and name like '%"+keyword+"%' and price>='"+price_lower+"' and price<='"+price_upper+"'";
			}			
		}
	}
...
%>
 	...
 	<div class="limiter">
        ...
        <div id="search_title">
	      ...
	      <form id="search_form" method="post" action="productList_buyer_flea.jsp?" onsubmit="return search_product()">
	        <div id="search_div">
	          <div id="search_first">
			...
			if(category=="all") // categoryX
			{
				if(price_lower==0 && price_upper==990000) // priceX
				{
					if(keyword=="") // keywordX
						...
						window.location.href="productList_buyer_flea.jsp?category=all&keyword="+keyword;
				}
				else // priceO
				{
					if(keyword=="") // keywordX
						window.location.href="productList_buyer_flea.jsp?category=all&price_lower="+price_lower+"&price_upper="+price_upper;
					else // keywordO
						window.location.href="productList_buyer_flea.jsp?category=all&keyword="+keyword+"&price_lower="+price_lower+"&price_upper="+price_upper;					
				}
			}
			else // categoryO
			{
				...
				{
					if(keyword=="") // keywordX
						window.location.href="productList_buyer_flea.jsp?category="+category;
					else // keywordO
						window.location.href="productList_buyer_flea.jsp?category="+category+"&keyword="+keyword;
				}
				else // priceO
				{
					if(keyword=="") // keywordX
						window.location.href="productList_buyer_flea.jsp?category="+category+"&price_lower="+price_lower+"&price_upper="+price_upper;
					else // keywordO
						window.location.href="productList_buyer_flea.jsp?category="+category+"&keyword="+keyword+"&price_lower="+price_lower+"&price_upper="+price_upper;					
				}				
			}
		  }
		});
